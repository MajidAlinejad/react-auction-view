    ...
    return (
      <React.Fragment>
        ...
        <Message info icon>
          ...
          <Message.Content>
            <Message.Header>
              لطفا پس از انجام معامله به کاربر امتیاز دهید!
            </Message.Header>
            <p>
              امتیاز شما کمکی مهم است برای ارائه خدمات بهتر ساعت ۸. از شما
              متشکریم!{' '}
            </p>
          </Message.Content>
        </Message>
